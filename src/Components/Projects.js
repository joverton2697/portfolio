...
// import {writing1, writing2, writing3, writing4, writing5, writing6, writing7, writing8, writingwriting9, writing10, writing11, writing12, writing13, writing14} from '../Images/Writing_Challenge';
import stateAuth from '../Images/StateAuth.png';
import writing1 from '../Images/Writing_Challenge/writing1.png';
import writing2 from '../Images/Writing_Challenge/writing2.png';
import writing3 from '../Images/Writing_Challenge/writing3.png';
import writing4 from '../Images/Writing_Challenge/writing4.png';
import writing5 from '../Images/Writing_Challenge/writing5.png';
import writing6 from '../Images/Writing_Challenge/writing6.png';
import writing7 from '../Images/Writing_Challenge/writing7.png';
import writing8 from '../Images/Writing_Challenge/writing8.png';
import writing9 from '../Images/Writing_Challenge/writing9.png';
import writing10 from '../Images/Writing_Challenge/writing10.png';
import writing11 from '../Images/Writing_Challenge/writing11.png';
import writing12 from '../Images/Writing_Challenge/writing12.png';
...
function Projects() {
    ...
    function showHide(selectedProject){
    ...
    return (
        <section id={"projects"}>
            ...
            <div className={"projects"}>
                ...
                <div className={"single_project"}>
                    <h3 onClick={() => showHide("writing")}>Writing Challenge</h3>
                    <div id={"writing"} className={"hide"}>
                        <Carousel>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing1}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing2}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing3}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing4}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing5}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing6}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing7}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing8}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing9}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing10}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing11}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing12}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing13}/>
                            </Carousel.Item>
                            <Carousel.Item>
                                <img className={"project_image"} src={writing14}/>
                            </Carousel.Item>
                        </Carousel>
                ...
                <div className={"single_project"}>
                    <h3 onClick={() => showHide("state")}>State Authorization Map</h3>
                    <div id={"state"} className={"hide"}>
